...
extends BroadcastReceiver {
    ...
    private final AmbientIndicationContainerPlay mAmbientIndicationContainerPlay;
    ...
    public AmbientIndicationService(Context context, AmbientIndicationContainerPlay ambientIndicationContainerPlay) {
        ...
        this.mAmbientIndicationContainerPlay = ambientIndicationContainerPlay;
    ...
    public void hideIndicationContainer() {
        this.mAmbientIndicationContainerPlay.hideIndication();
    }
    ...
    public void onReceive(Context object, Intent intent) {
        ...
        if (intent.getAction().equals("com.google.android.ambientindication.action.AMBIENT_INDICATION_SHOW")) {
            ...
            this.mAmbientIndicationContainerPlay.setIndication(charSequence, pIntent);
