...
public class AmbientIndicationContainerPlay
...
implements DozeReceiver {
    ...
    private void updateColors() {
        ...
        this.mTextColorAnimator.addListener((Animator.AnimatorListener)new AnimatorListenerAdapter(){
            ...
            public void onAnimationEnd(Animator animator2) {
                AmbientIndicationContainerPlay.this.mTextColorAnimator = null;
            }
        });
    ...
    public void updateAmbientIndicationView(View view) {
        this.mAmbientIndication = this.findViewById(R.id.ambient_indication_play);
        this.mText = (TextView)this.findViewById(R.id.ambient_indication_text_play);
        this.mIcon = (ImageView)this.findViewById(R.id.ambient_indication_icon_play);
