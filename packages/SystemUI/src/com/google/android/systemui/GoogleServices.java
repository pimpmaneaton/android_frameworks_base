...
extends VendorServices {
    ...
    public void start() {
        ...
        AmbientIndicationContainerPlay ambientIndicationContainerPlay = (AmbientIndicationContainerPlay)statusBar.getStatusBarWindow().findViewById(R.id.ambient_indication_container_play);
        ambientIndicationContainerPlay.initializeView(statusBar);
        this.addService((Object)new AmbientIndicationService(this.mContext, ambientIndicationContainerPlay));
    }
}
